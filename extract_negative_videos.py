...
def extract_negative_samples(corpus, vid2captions):
    ...
    with open("/content/SGN/data/{}/metadata/words_stats.csv".format(corpus), 'w') as fout:
    ...
    with open("/content/SGN/data/{}/metadata/stopwords_stats.csv".format(corpus), 'w') as fout:
        batch_size = 10
    ...
    with open("/content/SGN/data/{}/metadata/vid2vocabs.json".format(corpus), 'w') as fout:
    ...
    with open("/content/SGN/data/{}/metadata/vid2neg_captions.json".format(corpus), 'w') as fout:
    ...
    with open("/content/SGN/data/{}/metadata/neg_vids_stats.csv".format(corpus), 'w') as fout:
